...
const ItemLink = ({ item }) => {
  ...
  return (
    <div className="bg-white border rounded-lg shadow-sm  mb-4">
      <div className="bg-slate-400 border rounded-lg">
        {item.image && (
          <img
      ...
      <div className="p-4">
        ...
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <a
              href={item.url}
              target="_blank"
              className="text-gray-800 font-semibold hover:underline hover:text-blue-600"
            >
              {item.title}
            </a>
        ...
        <div className="mt-4 text-sm text-gray-800">{item.description}</div>
